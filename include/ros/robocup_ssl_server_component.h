...
#include "rclcpp/rclcpp.hpp"
#include "ros2_grsim/msg/vision_detections.hpp"
#include "ros2_grsim/msg/vision_geometry.hpp"
...
public:
    ROBOCUP_SSL_SERVER_COMPONENT_PUBLIC
    explicit RoboCupSSLServerComponent(const rclcpp::NodeOptions & options){
      pub_geometry =
        this->create_publisher<ros2_grsim::msg::VisionGeometry>("~/raw_vision_geometry", 1);
      pub_detection =
        this->create_publisher<ros2_grsim::msg::VisionDetections>("~/raw_vision_detections", 1);
    ...
    bool send(const SSL_WrapperPacket & packet){
      this->converter.publishSSLPacket(packet);
    }
...
protected:  
  rclcpp::Publisher<ros2_grsim::msg::VisionGeometry>::SharedPtr pub_geometry;
  rclcpp::Publisher<ros2_grsim::msg::VisionDetections>::SharedPtr pub_detection;
